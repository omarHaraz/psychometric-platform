...
INSERT INTO gcat_questions (item_code, subtest_id, difficulty, exam_mode, title_ar, pattern_type_ar, prompt_text_ar, observation_ar, rule_ar, application_ar, correct_option_key, is_active, exposure_count, created_at) VALUES ('GCAT-VER-11', 6, 'MEDIUM', 'FULL', 'التناظر اللفظي', 'علاقة التضاد الاتجاهي', 'ما الاختيار الأكثر تقارباً مع المفردات التالية من حيث العلاقة والارتباط؟
...
INSERT INTO gcat_questions (item_code, subtest_id, difficulty, exam_mode, title_ar, pattern_type_ar, prompt_text_ar, observation_ar, rule_ar, application_ar, correct_option_key, is_active, exposure_count, created_at) VALUES ('GCAT-VER-12', 6, 'EASY', 'FULL', 'التناظر اللفظي', 'علاقة المهنة بمكان العمل', 'طبيب : مستشفى = ؟', 'العلاقة بين "طبيب" و "مستشفى" هي علاقة المهني بمكان عمله الرئيسي.', 'نبحث عن خيار يربط بين مهنة والمكان المخصص لممارستها.', 'الزوج "معلم : مدرسة" يطابق هذه العلاقة تماماً.', 'A', 1, 0, NOW());
SET @question_id = LAST_INSERT_ID();
...
INSERT INTO gcat_questions (item_code, subtest_id, difficulty, exam_mode, title_ar, pattern_type_ar, prompt_text_ar, observation_ar, rule_ar, application_ar, correct_option_key, is_active, exposure_count, created_at) VALUES ('GCAT-VER-13', 6, 'EASY', 'FULL', 'التناظر اللفظي', 'علاقة الأداة بوظيفتها', 'قلم : كتابة = ؟', 'العلاقة بين "قلم" و "كتابة" هي علاقة الأداة بوظيفتها الأساسية.', 'نبحث عن زوج كلمات يربط أداة معينة بالغرض المخصص لها.', 'الزوج "سكين : قطع" يمثل الأداة (السكين) ووظيفتها (القطع).', 'B', 1, 0, NOW());
SET @question_id = LAST_INSERT_ID();
