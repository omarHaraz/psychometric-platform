...
old_logic = """    const rightSpacer = document.getElementById("rightSpacer");
...
new_logic = """    const rightSpacerEmpty = document.getElementById("rightSpacerEmpty");
...
js = js.replace('"Battery Overview": "نظرة عامة على البطارية"', '"Battery Overview": "نظرة عامة على البطارية",' + new_i18n)
